...
function Signup() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-surface dark:bg-neutral-900">
      <div className="w-full max-w-md space-y-8 p-8 bg-white dark:bg-neutral-800 rounded-lg shadow-md">
